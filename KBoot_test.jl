...
actual_wind_scenarios_variance = get_actual_scenarios(wind_scenario_variance, wind_event_quantile, hour_of_interest);
actual_solar_scenarios_variance = get_actual_scenarios(solar_scenario_variance, solar_event_quantile, hour_of_interest);
actual_load_scenarios_variance = get_actual_scenarios(load_scenario_variance, load_event_quantile, hour_of_interest);
