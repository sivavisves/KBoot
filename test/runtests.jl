...
@testset "KBoot.jl" begin
    ...
    file_wind = "HDF5_Test/wind_scenario_blocks_hour_0_test.h5"
    file_solar = "HDF5_Test/solar_scenario_blocks_hour_0_test.h5"
    file_load = "HDF5_Test/load_scenario_blocks_hour_0_test.h5"
    ...
    @test load_scenario = load_scenarios(file_load, "DateTimeTexas") == load_scenario_test
end
