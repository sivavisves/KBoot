...
function process_energy_data_variance(df_wind::DataFrame, current_hour::Int64, current_min::Int64, horizon::Int64)

    blocks_wind = block_disection(df_wind, current_hour, current_min, horizon);
...
function process_energy_data_quantile(df_wind::DataFrame, current_hour::Int64, current_min::Int64, horizon::Int64)
